...
public class Bidding {
    ...
    // and this can be served as a foreign key to connect with user table & project_listing table
    ...
    // for instance, a car restorer could restore bumpers or car lamps, or engines, etc.
