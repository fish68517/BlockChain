...
const InputBase = require('@mui/material/InputBase');
...
const AccountCircle = require('@mui/icons-material/AccountCircle');
const MailIcon = require('@mui/icons-material/Mail');
const NotificationsIcon = require('@mui/icons-material/Notifications');
const MoreIcon = require('@mui/icons-material/MoreVert');
...
module.exports = function AppToolBar() {
