...
const WalletLogin = require("./forms/WalletLoginComponent");
...
const AdminLogin = require("./forms/AdminLoginComponent");
...
function Navigation(props) {
  ...
  return (
    <Routes>
      {/* Wallet login is the main auth route */}
      <Route path="login" element={<WalletLogin />} />
      <Route path="wallet-login" element={<WalletLogin />} />
      <Route path="register" element={<WalletLogin />} />
      <Route exact path="/logout" element={<Logout />} />
      <Route path="admin-login" element={<AdminLogin />} />

      {/* Redirect to wallet-login if not logged in */}
      {!props.user && (
        <Route exact path="/" element={<Navigate to="/wallet-login" />} />
      )}
